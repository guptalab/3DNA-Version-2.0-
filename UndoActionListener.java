    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(MainFrame.isImported){
            ...
            if(!CanvasActionListener.undoStack.isEmpty()){
                ...
                tg.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
                Transform3D transform = new Transform3D();
                Vector3f vector = new Vector3f(undoCoOrdinates.x*0.105f,undoCoOrdinates.y*-0.105f,undoCoOrdinates.z*-0.105f);
                transform.setTranslation(vector);
                tg.addChild(c1);
                tg.setTransform(transform);
                BranchGroup undoGroup=new BranchGroup();
                ...
                MainFrame.printLog("Voxel added at coordinates: [" + undoCoOrdinates.x+ ", " + undoCoOrdinates.y+ ", " + undoCoOrdinates.z+ "]" +
                        " [" + undoCoOrdinates.x+ ", " + undoCoOrdinates.y+ ", " + (undoCoOrdinates.z+ 1) + "]", Color.cyan);
